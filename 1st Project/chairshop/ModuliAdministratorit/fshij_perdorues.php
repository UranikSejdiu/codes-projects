...
<?php
	...
	"SELECT * FROM users ORDER BY ID_usr DESC");
?>
<!DOCTYPE html>
<html>
				...
				<div class="row">
						...
						<form style="margin: auto;" action="" method="post">
							...
							<tr>
								...
								<td>
									<input class="form-control" type="text" name="term" placeholder="Përdoruesin ose Email-in"/>
								</td>
						...
						<div class="table">
							<table width="100%;" style="text-align: center;">
								<tr>
									<td style="padding: 5px;">Përdoruesi</td>
									<td style="padding: 5px;">Fjalëkalimi</td>
									...
									<?php
										if (!empty($_REQUEST['term'])) {
											...
											while($row = mysqli_fetch_array($sql)) {
													...
													echo "<td><a href=\"delete.php?ID_usr=$row[ID_usr]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini perdoruesin?')\"class='tm-btn tm-btn-danger'>Fshijë</a></td></tr>";
												}
										}
