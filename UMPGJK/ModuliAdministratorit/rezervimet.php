		...
		<div id="page-wrapper">
			...
			<!-- Four -->
				<section id="one" class="wrapper style1 special fade-up">
					<div class="container">
						<header class="major">
							<h2>Forma për menaxhimin e rezervimeve për gjuajtje</h2>
						...
						<div class="box alt">
							<div class="row gtr-uniform">
								<section class="col-4 col-6-medium col-12-xsmall">
									...
									<h3>Forma për shtimin e rezervimeve</h3>
									<br>
									<a href="shto_rezervime.php" class="button">Shto</a>
								</section>
								<section class="col-4 col-6-medium col-12-xsmall">
									<span class="icon solid alt major fa-pencil-alt"></span>
									<h3>Forma për modifikimin e rezervimeve</h3>
									<a href="ndrysho_rezervime.php" class="button">Ndrysho</a>
								</section>
								<section class="col-4 col-6-medium col-12-xsmall">
									<span class="icon solid alt major fa-eraser"></span>
									<h3>Forma për fshirjen e rezervimeve</h3>
									<br>
									<a href="fshi_rezervime.php" class="button">Fshi</a>
								</section>
