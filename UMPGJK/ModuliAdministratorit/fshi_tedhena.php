...
while($row = mysqli_fetch_array($sql)) { 		
		...
		echo "<td><a href=\"fshiTeDhena.php?ID_tedhena=$row[ID_tedhena]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini?')\" class='button' class='button primary'>Fshi</a></td></tr>";		
	}
