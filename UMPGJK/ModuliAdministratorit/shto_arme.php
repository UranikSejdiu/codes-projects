		...
		<div id="page-wrapper">
			...
			<!-- Four -->
				<section id="one" class="wrapper style1 special fade-up">
					<div class="container">
						<header class="major">
							<h2>Forma për shtimin e të dhënave të armëve</h2>
							
						</header>
						<div class="box alt">
							<form method="post" action="shtoArme.php" enctype="multipart/form-data">
							<table >
								<tr>
									<td>Emri:</td>
								...
								<tr>
           							<td>Ngarko foton e armës: </td>		
									<td>
										<input name="foto" type="file" onchange="preview_image(event)"/>
								...
								<tr>
									<td></td>
									<td><img id="output_image" style="max-width:200px; display: block;" /></td>
								</tr>
								<tr>
									<td></td>
