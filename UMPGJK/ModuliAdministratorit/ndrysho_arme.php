		...
		<div id="page-wrapper">
			...
			<!-- Four -->
				<section id="one" class="wrapper style1 special fade-up">
					<div class="container">
						<header class="major">
							<h2>Forma për menaxhimin e të dhënave të armës</h2>
							...
							<form action="" method="post">
								<table>
									...
									<tr>
										...
										<td>
											<input type="text" name="term" placeholder="Emri armës"/>
										</td>
...
"CALL selectArmet('$term')"); 
while($row = mysqli_fetch_array($sql)) { 		
		echo "<tr>";
		echo "<td>".$row['Emri']."</td>";
		echo "<td><img src=data:image/jpeg;base64,".base64_encode($row['Fotoja'])." width='100'  height='80'/></td>";
		echo "<td>".$row['fotojaEmri']."</td>";
		echo "<td><a href=\"ndryshoArmen.php?ID_arma=$row[ID_arma]\" class='button' class='button primary'>
		Ndrysho</a></td></tr>";		
	}
