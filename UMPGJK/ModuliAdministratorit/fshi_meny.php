					...
					<div class="container">
						...
						<table>
							...
							<?php
								...
								"CALL selectTermMeny('$term')"); 
								while($row = mysqli_fetch_array($sql)) { 		
										echo "<tr>";
										echo "<td>".$row['meny_emri']."</td>";
										echo "<td>".$row['meny_linku']."</td>";
										echo "<td>".$row['modul']."</td>";
										echo "<td><a href=\"fshiMeny.php?meny_id=$row[meny_id]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini?')\" class='button' class='button primary'>Fshi</a></td></tr>";		
									}
