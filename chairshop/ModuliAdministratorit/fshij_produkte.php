			...
			<div class="tm-container-inner tm-features">
				<div class="row">
						...
						<form style="margin: auto;" action="" method="post">
							<table>
								<tr>
									<h3>Kërko të dhënat e produktit për fshirje</h3>
								</tr>
							<tr>
								<td>
						...
						<div class="table">
							<table width="100%;" style="text-align: center;">
								<tr>
									...
									<td style="padding: 10px;">Fshijë</td>
								</tr>
								<?php
...
WHERE
  s.Emri LIKE '%".$term."%' OR d.Lloji LIKE '%".$term."%'"
			...
			echo "<td><a href=\"delete_produkte.php?ID_prod=$row[ID_prod]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini produktin?')\" class='tm-btn tm-btn-danger'>Fshijë</a> </td>";
		}
