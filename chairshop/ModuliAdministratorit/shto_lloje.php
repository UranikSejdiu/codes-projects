	...
	<!-- Top box -->
		...
		<main>
			...
			<div class="tm-container-inner tm-features">
				<p class="col-12 text-center" style="margin-bottom: 25px; font-size: 1.5rem;">Shëno Llojin: </p>
					<form action="addLloje.php" method="POST" style="margin: auto;" class="tm-contact-form">
				        <div class="form-group ">
				          <input class="form-control" type="text" name="lloji" id="lloji" value="" placeholder="Lloji" required=""/>
				        </div>

				        <div class="form-group tm-d-flex">

				          <input type="submit" name="addLloje" value="Shto" class="tm-btn tm-btn-success tm-btn-right">
