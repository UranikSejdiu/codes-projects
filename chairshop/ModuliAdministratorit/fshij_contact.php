...
<?php
	...
	"SELECT * FROM contact ORDER BY con_ID DESC");
?>
<!DOCTYPE html>
<html>
			...
			<div class="tm-container-inner tm-features">
				<div class="row">
						...
						<form style="margin: auto;" action="" method="post">
							<table>
								<tr>
									<h3>Kërko të dhënat e kontaktit që dëshironi të fshini</h3>
								</tr>
							<tr>
								<td>
								...
								<td>
									<input class="form-control" type="text" name="term" placeholder="Emrin ose Email-in"/>
								</td>
									...
									<?php
										if (!empty($_REQUEST['term'])) {
											...
											while($row = mysqli_fetch_array($sql)) {
													...
													$mesage=$row['Mesazhi'];
													$msg=substr($mesage,0,25);
													echo "<td>".$msg."...</td>";
													echo "<td><a href=\"delete_contact.php?con_ID=$row[con_ID]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini kontaktin?')\"class='tm-btn tm-btn-danger'>Fshijë</a></td></tr>";
												}
										}
